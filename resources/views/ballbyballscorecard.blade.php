...
<div>
  <div class="match-content">
      ...
      <div class="with-nav-tabs panel-default">
              ...
              <li id="ballByBallTeamTab1"><a href="#ballByBallTeam1" role="tab" data-toggle="tab" onclick="resizeScroll();">{{$teams_one}}</a></li>
              <li id="ballByBallTeamTab2" class="active"><a href="#ballByBallTeam2" role="tab" data-toggle="tab" onclick="resizeScroll();">{{$teams_two}}</a></li>
                                                  ...
                                                  <div class="row">
                                                      <div class="col-sm-3 col-xs-6 sp"> 
                                                          <div class="end-head" style="text-align: left;">                                                           
                                                              <p style="line-height: 1.85">Over {{ sprintf('%.1f', $total_overs) }}
                                                                   (8 Runs)</p>
                                                            </div>
                                                        </div>
