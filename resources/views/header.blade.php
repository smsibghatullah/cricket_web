                                    ...
                                    <tr>
                                        <td style='width:100px;height:100px;'><a
                                                href="MississaugaCricketLeague.html"><img
                                                    src="http://www.eoscl.com/img/eoscl-logo.png" border="0"
        ...
        <div class="col-sm-12">
            <div class="col-sm-12 add-phone">
                ...
                <div class="slick-carousel-header">
                                    ...
                                    <tr>
                                        <td class='thinBorder' title='Yashi Sports' style='padding:0px;height:90px;'>
                                            <img style='border-style:none;'
                                                src='https://cricclubs.com/documentsRep/sponsors/2565-0e3d4558-82e9-40e0-bc38-160bdf935551-sponsor.jpg' />
                                        </td>
                                    </tr>
                                </table>
                            </a>
                            ...
                            <a href='https://www.sbsexpedited.com/' style='text-decoration: none;' target='_blank'>
                                <table class='thinBorder'>
                                    <tr>
                                        <td class='thinBorder' title='SBS Expedite Services Ltd.'
                                            style='padding:0px;height:90px;'><img style='border-style:none;'
                                                src='https://cricclubs.com/documentsRep/sponsors/2565-576e021e-899c-4d43-ac08-272ddcfb767b-sponsor.png' />
                                        </td>
                                    </tr>
                                </table>
                            </a>
                                ...
                                <table class='thinBorder'>
                                    <tr>
                                        <td class='thinBorder' title='Fusion Launge' style='padding:0px;height:90px;'>
                                            <img style='border-style:none;'
                                                src='https://cricclubs.com/documentsRep/sponsors/2565-b0485042-6d8d-4524-9407-7015145dd0ed-sponsor.png' />
                                        </td>
                                    </tr>
                                </table>
                            </a>
                    ...
                    <div style="margin-left:15px;margin-right:15px;display:flex;">
                        <div class="spon-image hvr-grow">
                            <a href='http://www.rgillcorporation.com/' style='text-decoration: none;' target='_blank'>
                                <table class='thinBorder'>
                                    <tr>
                                        <td class='thinBorder' title='R Gill Corporation'
                                            style='padding:0px;height:90px;'><img style='border-style:none;'
                                                src='https://cricclubs.com/documentsRep/sponsors/2565-b96a102a-9add-4af8-998d-d2885daa015a-sponsor.JPG' />
                                        </td>
                                    </tr>
                                </table>
                            </a>
                    ...
                    <div style="margin-left:15px;margin-right:15px;display:flex;">
                        <div class="spon-image hvr-grow">
                            <a href='http://www.paradisechicken.ca/' style='text-decoration: none;' target='_blank'>
                                <table class='thinBorder'>
                                    <tr>
                                        <td class='thinBorder' title='Paradise Chicken'
                                            style='padding:0px;height:90px;'><img style='border-style:none;'
                                                src='https://cricclubs.com/documentsRep/sponsors/2565-a46fc71c-6349-403e-9af2-11b678ac34a2-sponsor.jpg' />
                                        </td>
                                    </tr>
                                </table>
                            </a>
                    ...
                    <div style="margin-left:15px;margin-right:15px;display:flex;">
                        <div class="spon-image hvr-grow">
                            <a href='https://khailsport.com/' style='text-decoration: none;' target='_blank'>
                                <table class='thinBorder'>
                                    <tr>
                                        <td class='thinBorder' title='Khail Sport' style='padding:0px;height:90px;'><img
                                                style='border-style:none;'
                                                src='https://cricclubs.com/documentsRep/sponsors/2565-7abf2b89-5715-4fca-8f80-d1bb3202403e-sponsor.jpg' />
                                        </td>
                                    </tr>
                                </table>
                            </a>
                    ...
                    <div style="margin-left:15px;margin-right:15px;display:flex;">
                        <div class="spon-image hvr-grow">
                            <a href='khailsport.com.html' style='text-decoration: none;' target='_blank'>
                                <table class='thinBorder'>
                                    <tr>
                                        <td class='thinBorder' title='Khail Sport' style='padding:0px;height:90px;'><img
                                                style='border-style:none;'
                                                src='https://cricclubs.com/documentsRep/sponsors/2565-dd42b430-07ce-47c8-bdd1-99a9ab42ceb2-sponsor.jpg' />
                                        </td>
                                    </tr>
                                </table>
                            </a>
                            ...
                            <li><a href="index.html#">Statistics</a>
                                <ul class="sub-menu">
                                    <li><a href="MississaugaCricketLeague/viewPointsTable.do%3FclubId=2565.html">Points
                                            Table</a></li>
                                    <li><a href="MississaugaCricketLeague/battingRecords.do%3FclubId=2565.html">Batting
                                            Records</a></li>
