    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-7 p-sm-0">
                <div id="newsDiv">
                    <div class="banner-slider-list" style="background-color: #fff; padding: 15px">
                        <div class="banner-content" style="height:inherit !important">
                            <div id="carousel-banner" class="carousel slide" style="heigth:inherit" data-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="item active">
                                        <iframe width="100%" height="347" src="https://www.youtube.com/embed/TeiYu22dcT8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen> </iframe>
                                        <div class="carousel-content ">
                                            <div class="container">
                                                ...
                                                <div class="carousel-content-panel content-sp" style="width: 100%">
                                                    <p>EOSCL is Launching Junior Cricket Academy and League, inauguration in Mid March, all junior clubs and kids are invited to meet and greet with EOSCL executives and Coach Rizwan Cheema. Stay Tune for detai...<a href="EOSCLCricketLeague/viewNews.do%3FnewsId=17&amp;clubId=2565.html" class="btn btn-ban pull-right">Read more <i class="fa fa-arrow-circle-o-right"></i></a><br>
                                                        <br>
                                                        <br>
                                                    </p>
                                    ...
                                    <div class="item ">
                                        <a href="EOSCLCricketLeague/viewNews.do%3FnewsId=8&amp;clubId=2565.html"><img src="http://eoscl.com/AdminPanel/App_Upload/TeamGroupPhotos/636995903787196807.jpg" width="100%" alt=".. ." class="box">
                                        </a>
                                        <div class="carousel-content ">
                                            <div class="container">
                                                <div class="carousel-content-panels">
                                                ...
                                                <div class="carousel-content-panel content-sp" style="width: 100%">
                                                    <p>EOSCL is Registered Community Group of city of EOSCL<a href="EOSCLCricketLeague/viewNews.do%3FnewsId=8&amp;clubId=2565.html" class="btn btn-ban pull-right">Read more <i class="fa fa-arrow-circle-o-right"></i></a><br>
                                                        <br>
                                                        <br>
                                                    </p>
                                ...
                                <div class="carousel-nav">
                                    <a class="carousel-nav-prev" href="index.html#carousel-banner" data-slide="prev">Prev</a> <a class="carousel-nav-next" href="index.html#carousel-banner" data-slide="next">Next</a>
                                </div>
                            </div>
                            <br />
                        </div>
                ...
                <div class="all-tab-table all-row-holder">
                    ...
                    <div id="parentHorizontalTab">
                        ...
                        <div class="resp-tabs-container hor_1">
                            <div class="about-player-all" id="92">
                                ...
                                <div class="all-tab-table all-row-holder">
                                    ...
                                    <div id="parentHorizontalTab" style="display: block; width: 100%; margin: 0px;">
                                        ...
                                        <div class="resp-tabs-container hor_1" style="border-color: rgb(193, 193, 193);">
                                            ...
                                            <div class="about-player-all resp-tab-content hor_1 resp-tab-content-active" id="92" aria-labelledby="hor_1_tab_item-0" style="display:block">
                                                <style>
                                                    <!--
                                                    .group-names li {
                                                                                ...
                                                                                <table>
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td><a href="viewPlayer.do?playerId=1242838&amp;clubId=2565"> Abubaker Kalair (MQ)</a></td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                            </th>
                                                                                ...
                                                                                <table>
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td><a href="viewPlayer.do?playerId=571631&amp;clubId=2565"> Vijay Subramanya (SCC)</a></td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                            </th>
                                                                                ...
                                                                                <table>
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td><a href="viewPlayer.do?playerId=2195533&amp;clubId=2565"> Shayan Ahmed (MQ)</a></td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                            </th>
                                                                                ...
                                                                                <table>
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td><a href="viewPlayer.do?playerId=881387&amp;clubId=2565"> Jaskirat Singh (SCC)</a></td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                            </th>
                                                                                ...
                                                                                <table>
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td><a href="viewPlayer.do?playerId=1695379&amp;clubId=2565"> Varun Sehdev (RPT)</a></td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                            </th>
                                                                                ...
                                                                                <table>
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td><a href="viewPlayer.do?playerId=1125372&amp;clubId=2565"> Yasir Abbasi (RC9)</a></td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                            </th>
                                                                                ...
                                                                                <table>
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td><a href="viewPlayer.do?playerId=2687684&amp;clubId=2565"> Manik Sharma (LCC)</a></td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                            </th>
                                                                                ...
                                                                                <table>
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td><a href="viewPlayer.do?playerId=1941554&amp;clubId=2565"> Kishore Gottuvedu.. (TCC)</a></td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                            </th>
                                                                                ...
                                                                                <table>
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            ...
                                                                                            <td><a href="viewPlayer.do?playerId=2684712&amp;clubId=2565"> Sunny Bhullar (SCC)</a></td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                            </th>
                                            ...
                                            <h2 class="resp-accordion hor_1" role="tab" aria-controls="hor_1_tab_item-1" style="background-color: rgb(245, 245, 245); border-color: rgb(193, 193, 193);"><span class="resp-arrow"></span>2022 MCLT20</h2>
                                            <div class="about-player-all resp-tab-content hor_1" id="93" aria-labelledby="hor_1_tab_item-1" style="border-color: rgb(193, 193, 193);">
                                                <img alt="Leagues Summary" title="Leagues Summary" src="/utilsv2/images/loading.gif">
                                                <br>Loading league summary data...
                                            </div>
                                            <h2 class="resp-accordion hor_1" role="tab" aria-controls="hor_1_tab_item-2" style="background-color: rgb(245, 245, 245); border-color: rgb(193, 193, 193);"><span class="resp-arrow"></span>2022 MCL100 - Super 8</h2>
                                            <div class="about-player-all resp-tab-content hor_1" id="91" aria-labelledby="hor_1_tab_item-2" style="border-color: rgb(193, 193, 193);">
                                                <img alt="Leagues Summary" title="Leagues Summary" src="/utilsv2/images/loading.gif">
                                                <br>Loading league summary data...
                                            </div>
                                            <h2 class="resp-accordion hor_1" role="tab" aria-controls="hor_1_tab_item-3" style="background-color: rgb(245, 245, 245); border-color: rgb(193, 193, 193);"><span class="resp-arrow"></span>2022 MCLT25</h2>
                                            <div class="about-player-all resp-tab-content hor_1" id="100" aria-labelledby="hor_1_tab_item-3" style="border-color: rgb(193, 193, 193);">
                                                <img alt="Leagues Summary" title="Leagues Summary" src="/utilsv2/images/loading.gif">
                                                <br>Loading league summary data...
                                            </div>
                                        </div>
                            ...
                            <div class="about-player-all" id="93">
                                <img alt="Leagues Summary" title="Leagues Summary" src="utilsv2/images/loading.gif" />
                                <br>Loading league summary data...
                            </div>
                            <div class="about-player-all" id="91">
                                <img alt="Leagues Summary" title="Leagues Summary" src="utilsv2/images/loading.gif" />
                                <br>Loading league summary data...
                            </div>
                            <div class="about-player-all" id="100">
                                <img alt="Leagues Summary" title="Leagues Summary" src="utilsv2/images/loading.gif" />
                                <br>Loading league summary data...
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-xs-6">
                                <div class="view text-right">
                                    <a href="EOSCLCricketLeague/articles.do%3FclubId=2565.html">View
                        ...
                        <div class="panel with-nav-tabs panel-default list-tab-mobile">
                            <div class="panel-heading">
                                <ul class="nav nav-tabs">
                                    <li class="" style="margin-right: 2px;"><a href="index.html#tab1default" data-toggle="tab">Live</a></li>
                                    <li class="center active" style="margin-left: 2px; margin-right: 2px;"><a href="index.html#tab2default" data-toggle="tab">Results</a></li>
                                    <li class="" style="margin-left: 2px; margin-right: 2px;"><a href="index.html#tab3default" data-toggle="tab">Schedule</a></li>
                                </ul>
                            </div>
                            <div class="panel-body">
                                <div class="tab-content">
                                    <div class="tab-pane fade " id="tab1default">
                                        <div id="live-score">
                                            ...
                                            <div class="complete text-center">
                                                <a href="EOSCLCricketLeague/listMatches.do%3FclubId=2565.html">Complete
                                                    list</a>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row list-slign">
                                                <div class="col-sm-4 col-xs-4">
                                                    <div class="vsteam-image">
                                                        <a title="03/19/2023" href="{{ url('fullScorecard/' . $match_result->id) }}">
                                                            <ul class="list-inline">
                                                                <li><img src="https://cricclubs.com/documentsRep/teamLogos/9deaa818-6154-4a1a-8eaf-89bb6e54f83d.jpg" class="img-responsive img-circle" style="width: 40px; height: 40px;" /></li>
                                                                <li><img src="https://cricclubs.com/documentsRep/teamLogos/57dddf01-13bf-48f5-bb38-bffc5faa2d67.jpeg" class="img-responsive img-circle" style="width: 40px; height: 40px;" /></li>
                                                            </ul>
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="col-sm-8 col-xs-8">
                                                    <div class="vsteam-text">
                                                        <h4>
                                                            <a class="list-score" style="color: inherit;" href="{{ url('fullScorecard/' . $match_result->id) }}">L:
...
margin-right: 10px;
    margin-top: -3px; cursor: pointer;
     " src="utilsv2/theme2-static/images/cric-ball.png" width="15px" height="15px" />
                                                        ...
                                                        <h5>
                                                            <a class="list-score" href="{{ url('fullScorecard/' . $match_result->id) }}">
    ...
    margin-right: 1rem;" href="{{ url('fullScorecard/' . $match_result->id) }}"> Scorecard</a>
                                    ...
                                    <div class="tab-pane fade " id="tab3default">
                                        ...
                                        <div class="team-vs-team">
                                            <div class="row list-slign">
                                                <div class="col-sm-4 col-xs-4">
                                                    <div class="vsteam-image">
                                                        <ul class="list-inline">
                                                            <li><img src="https://cricclubs.com/documentsRep/teamLogos/95c38746-679e-45d2-804d-2971933b0169.jpg" class="img-responsive img-circle" style="width: 40px; height: 40px;" /></li>
                                                            <li><img src="https://cricclubs.com/documentsRep/teamLogos/a2530a09-334e-4d16-9206-1dfb63857ac8.jpg" class="img-responsive img-circle" style="width: 40px; height: 40px;" /></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <div class="col-sm-8 col-xs-8">
                                                    <div class="vsteam-text">
                                                        <h4>L:
                                                            <a href="EOSCLCricketLeague/viewTeam.do%3FteamId=1092&amp;clubId=2565.html">
                                                                {{$teams[$upcoming_match->team_id_a]}}</a>

                                                            - vs -
                                                            <a href="EOSCLCricketLeague/viewTeam.do%3FteamId=1075&amp;clubId=2565.html">
                                                                {{$teams[$upcoming_match->team_id_b]}}</a>
                                                        </h4>
                                                        <h5>

                                                            at <a href="EOSCLCricketLeague/viewGround.do%3FgroundId=43&amp;clubId=2565.html" target="_new">{{$ground[$upcoming_match->ground_id]}}</a>
                                        ...
                                        <div class="complete text-center">
                                            <a href="EOSCLCricketLeague/fixtures.do%3FclubId=2565.html">Complete
                                                list</a>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6 sp">
                                <div class="gallery-image-all">
                                    <a title="EOSCL AWARDS 2018" href="EOSCLCricketLeague/viewAlbum.do%3FalbumId=1&amp;clubId=2565.html">
                                        <div class="gallery-image">
                                            <img src='http://eoscl.com/AdminPanel/App_Upload/TeamGroupPhotos/636995904247192654.jpg' class="img-responsive center-block" />
                                        </div>

                                    </a>
                                    <div class="gallery-text">

                                        <!-- <i class="fa fa-camera-retro" style="font-size: 14px;"></i> --> <b style="font-size: 14px;">EOSCL AWARDS 2022</b>
                                ...
                                <div class="gallery-image-all">
                                    <a title="EOSCL AWARDS 2018" href="EOSCLCricketLeague/viewAlbum.do%3FalbumId=1&amp;clubId=2565.html">
                                        <div class="gallery-image">
                                            <img src='http://eoscl.com/AdminPanel/App_Upload/TeamGroupPhotos/636995903787196807.jpg' class="img-responsive center-block" />
                                        </div>

                                    </a>
                                    <div class="gallery-text">

                                        <!-- <i class="fa fa-camera-retro" style="font-size: 14px;"></i> --> <b style="font-size: 14px;">EOSCL AWARDS 2023</b>
                ...
                <div class="facebook">
                    ...
                    <div style=" overflow-y: scroll; max-height: 500px; ">
                        <a class="twitter-timeline" href="https://twitter.com/EEoscl?ref_src=twsrc%5Etfw%7Ctwcamp%5Etweetembed%7Ctwterm%5E1003005776129150976%7Ctwgr%5E2eef71c9b1181f3aed0a5fb71c24b561abaad9b9%7Ctwcon%5Es1_&ref_url=http%3A%2F%2Fwww.eoscl.com%2FDefault.aspx">Tweets by MissCricLeague</a>
    ...
    <div id="content" style="display: none; visible: false;">
        ...
        <a id="example7" href="https://cricclubs.com/documentsRep/startup/2565-startup.JPG" title="Welcome to EOSCL"></a>
        <div id="inline1" style="width: 500px; height: 300px; overflow: auto;">
            Welcome to EOSCL</div>

    </div>

    <div id="dialogOpenVideoLink" class="dialogOpenVideoLink" title="Ball Video" style="display: none;">
        <center>

            <iframe class="playVideo" id="playVideo" src="index.html" width="640px" height="360px" allowfullscreen></iframe>
