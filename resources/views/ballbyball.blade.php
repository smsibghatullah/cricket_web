					                   ...
					                   <div class="schedule-logo text-center vsteam-image">
					                       ...
					                       <ul class="list-inline" style="display:flex; align-items:center; justify-content:center">
					                           <li class="lose" style="width:25%">
					                           		<span class="teamName">Toronto Jaguars<br></span>
					                           ...
					                           <li class="win" style="width:25%">
					                           		<span class="teamName">Royal Tigers<br></span>
					                           <span>93/1</span> <br> 
						                           		<p style="text-transform: lowercase;">
						                           		9.4/12 ov 
						                           		</p>
           	 	...
           	 	<div class="panel with-nav-tabs panel-default">
                       <div class="panel-heading score-tabs">
                           <ul class="nav nav-tabs">
  							<li class="active"><a href="#tab1default" role="tab" data-toggle="tab" onclick="loadView('ballbyball');">Ball By Ball</a></li>
...
<div>
  <div class="match-content">
      ...
      <div class="with-nav-tabs panel-default">
              ...
              <li id="ballByBallTeamTab1"><a href="#ballByBallTeam1" role="tab" data-toggle="tab" onclick="resizeScroll();">Toronto Jaguars</a></li>
              <li id="ballByBallTeamTab2" class="active"><a href="#ballByBallTeam2" role="tab" data-toggle="tab" onclick="resizeScroll();">Royal Tigers</a></li>
...
<!-- Test match Start -->                        
          ...
          <div class="ball-by-ball-section">
                   ...
                   <li class="col3">
                                    <strong>Royal Tigers Players: </strong>Abdul Rehman Alamgir, Abdullah Abbas, Aziz Hassan, Imran Samdani, Irfan Sadaat, Mubashir Jawed, Muhammad Salman Arshad, Mujtaba Jiwani, Noman Siddiqui, Saad Haroon, Turab Ghani</li>
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                   ...
                   <li class="col3">
                                    <strong>Toronto Jaguars Players: </strong>Adeel Ali, Atanu Bharali, Gurpreet Singh, Imran Nahid, Jibran Shaukat, Mohammedi, Omar Edwards, Ramkiran Nersu, Usman Aziz</li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:30 PM<span> </span></span>
                   ...
                   <li class="col3">
                                    <strong>Toronto Jaguars won the toss  and elected to bat</strong></li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:30 PM<span> </span></span>
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651476">
                   ...
                   <li class="col3">
                                     Usman Aziz, comes to the crease.</li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:32 PM<span> </span></span>
                       
                       <div class="col-1 text-right lakshman"> 
                       </div>
                      </ul>
                                <ul class="list-inline bbb-row" id="ballid_651478">
                   ...
                   <li class="col3">
                                     Atanu Bharali, comes to the crease.</li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:33 PM<span> </span></span>
                       
                       <div class="col-1 text-right lakshman"> 
                       </div>
                      </ul>
                                <ul class="list-inline bbb-row" id="ballid_651479">
                   ...
                   <li class="col3">
                                     Irfan Sadaat, comes into the attack</li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:33 PM<span> </span></span>
                   ...
                   <li class="col2">
                                <span class="zero"><i class="fa fa-dot-circle-o"></i></span>
                                <span class="ov" style="padding-left: 5px;">
                   ...
                   <li class="col3">
                                    Irfan S to Atanu B, 0 run </li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:34 PM<span> </span></span>
                       
                       <div class="col-1 text-right lakshman"> 
                       </div>
                      </ul>
                                <ul class="list-inline bbb-row" id="ballid_651490">
                              
                  
                   <li class="col2">
                                <span class="runs">2</span>
                                  <span class="ov" style="padding-left: 5px;">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651492">
                   ...
                   <li class="col3">
                                    Irfan S to Usman A, 2 runs </li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:35 PM<span> </span></span>
                       
                       <div class="col-1 text-right lakshman"> 
                       </div>
                      </ul>
                                <ul class="list-inline bbb-row" id="ballid_651495">
                              
                  
                   <li class="col2">
                                <span class="runs" style="padding: 11px 10px;">1wd</span>
                                  <span class="ov" style="padding-left: 5px;">
                   ...
                   <li class="col3">
                                    Irfan S to Atanu B<strong> WIDE</strong></li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:35 PM<span> </span></span>
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651499">
                   ...
                   <li class="col3">
                     ...
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:36 PM<span> </span></span>
                       
                       <div class="col-1 text-right lakshman"> 
                       </div>
                      </ul>
                                <ul class="list-inline bbb-row" id="ballid_651501">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651503">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <div class="end-over">
                                                  ...
                                                  <div class="row">
                                                      <div class="col-sm-3 col-xs-6 sp"> 
                                                          <div class="end-head" style="text-align: left;">                                                           
                                                              <p style="line-height: 1.85">Over 1  
                                                                   (7 Runs)</p>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4 col-xs-12 sp over-ending">  
                                                          <div class="end-test">
                                                          <p style="line-height: 1.85">Usman A<span style="float: right;"> 2 (3)</span></p>
                                                               <p style="line-height: 1.85"> Atanu B<span style="float: right;"> 4 (3)</span> </p>
                                                                </div>
                                                        </div>
                                                        <div class="col-sm-5 col-xs-12 sp"> 
                                                          <div class="end-test">
                                                                <p style="line-height: 1.85">Irfan S<span style="float: right;"> 1.0-0-7-0</span> </p>
                                                              <p style="line-height: 1.85" class="hidden-phone">Run Rate : <span style="float: right"> 7.00</span>
                                                              </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-sm-2 sp">
                                              <div class="end-head sp">
                                                <table style="width: 100%"><tbody><tr><td>
                                                    ...
                                                    <h4><span>7/0</span></h4>
                                                    </td><td style="text-align: right;"><label class="show-phone" style="font-size: 14px;color: white;">Run Rate : 7.00</label></td></tr></tbody></table>
                                                </div>
                                    ...
                                    <ul class="list-inline bbb-row" id="ballid_651505">
                   ...
                   <li class="col3">
                                     Mujtaba Jiwani, comes into the attack</li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:37 PM<span> </span></span>
                       
                       <div class="col-1 text-right lakshman"> 
                       </div>
                      </ul>
                                <ul class="list-inline bbb-row" id="ballid_651508">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651511">
                   ...
                   <li class="col3">
                     ...
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:38 PM<span> </span></span>
                       
                       <div class="col-1 text-right lakshman"> 
                       </div>
                      </ul>
                                <ul class="list-inline bbb-row" id="ballid_651514">
                   ...
                   <li class="col3">
                                    Mujtaba J to Atanu B, 4 runs <strong> FOUR</strong></li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:38 PM<span> </span></span>
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651518">
                   ...
                   <li class="col3">
                     ...
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:39 PM<span> </span></span>
                       
                       <div class="col-1 text-right lakshman"> 
                       </div>
                      </ul>
                                <ul class="list-inline bbb-row" id="ballid_651522">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651528">
                   ...
                   <li class="col3">
                                    Mujtaba J to Atanu B, 2 runs </li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:40 PM<span> </span></span>
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <div class="end-over">
                                       ...
                                       <div class="col-sm-10 sp">
                                              <div class="end-red">
                                                  <div class="row">
                                                      <div class="col-sm-3 col-xs-6 sp"> 
                                                          <div class="end-head" style="text-align: left;">                                                           
                                                              <p style="line-height: 1.85">Over 2  
                                                                   (6 Runs)</p>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4 col-xs-12 sp over-ending">  
                                                          <div class="end-test">
                                                          <p style="line-height: 1.85">Atanu B<span style="float: right;"> 10 (9)</span></p>
                                                               <p style="line-height: 1.85"> Usman A<span style="float: right;"> 2 (3)</span> </p>
                                                                </div>
                                                        </div>
                                                        <div class="col-sm-5 col-xs-12 sp"> 
                                                          <div class="end-test">
                                                                <p style="line-height: 1.85">Mujtaba J<span style="float: right;"> 1.0-0-6-0</span> </p>
                                                              <p style="line-height: 1.85" class="hidden-phone">Run Rate : <span style="float: right"> 6.50</span>
                                                              </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-sm-2 sp">
                                              <div class="end-head sp">
                                                <table style="width: 100%"><tbody><tr><td>
                                                    <h4 class="hidden-phone">TOR</h4>
                                                    <h4 class="show-phone">Toronto Jaguars</h4>
                                                    <h4><span>13/0</span></h4>
                                                    </td><td style="text-align: right;"><label class="show-phone" style="font-size: 14px;color: white;">Run Rate : 6.50</label></td></tr></tbody></table>
                                                </div>
                                    ...
                                    <ul class="list-inline bbb-row" id="ballid_651530">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651532">
                   ...
                   <li class="col3">
                     ...
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:41 PM<span> </span></span>
                       
                       <div class="col-1 text-right lakshman"> 
                       </div>
                      </ul>
                                <ul class="list-inline bbb-row" id="ballid_651537">
                              
                  
                   <li class="col2">
                                <span class="runs">1</span>
                                  <span class="ov" style="padding-left: 5px;">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651540">
                   ...
                   <li class="col3">
                     ...
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:42 PM<span> </span></span>
                       
                       <div class="col-1 text-right lakshman"> 
                       </div>
                      </ul>
                                <ul class="list-inline bbb-row" id="ballid_651542">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651544">
                   ...
                   <li class="col3">
                     ...
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:43 PM<span> </span></span>
                       
                       <div class="col-1 text-right lakshman"> 
                       </div>
                      </ul>
                                <ul class="list-inline bbb-row" id="ballid_651551">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <div class="end-over">
                                       ...
                                       <div class="col-sm-10 sp">
                                              <div class="end-red">
                                                  <div class="row">
                                                      <div class="col-sm-3 col-xs-6 sp"> 
                                                          <div class="end-head" style="text-align: left;">                                                           
                                                              <p style="line-height: 1.85">Over 3  
                                                                   (2 Runs)</p>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4 col-xs-12 sp over-ending">  
                                                          <div class="end-test">
                                                          <p style="line-height: 1.85">Usman A<span style="float: right;"> 2 (5)</span></p>
                                                               <p style="line-height: 1.85"> Atanu B<span style="float: right;"> 12 (13)</span> </p>
                                                                </div>
                                                        </div>
                                                        <div class="col-sm-5 col-xs-12 sp"> 
                                                          <div class="end-test">
                                                                <p style="line-height: 1.85">Irfan S<span style="float: right;"> 2.0-0-9-0</span> </p>
                                                              <p style="line-height: 1.85" class="hidden-phone">Run Rate : <span style="float: right"> 5.00</span>
                                                              </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-sm-2 sp">
                                              <div class="end-head sp">
                                                <table style="width: 100%"><tbody><tr><td>
                                                    <h4 class="hidden-phone">TOR</h4>
                                                    <h4 class="show-phone">Toronto Jaguars</h4>
                                                    <h4><span>15/0</span></h4>
                                                    </td><td style="text-align: right;"><label class="show-phone" style="font-size: 14px;color: white;">Run Rate : 5.00</label></td></tr></tbody></table>
                                                </div>
                                    ...
                                    <ul class="list-inline bbb-row" id="ballid_651556">
                   ...
                   <li class="col3">
                     ...
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:44 PM<span> </span></span>
                       
                       <div class="col-1 text-right lakshman"> 
                       </div>
                      </ul>
                                <ul class="list-inline bbb-row" id="ballid_651558">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651561">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651565">
                   ...
                   <li class="col3">
                                    Mujtaba J to Usman A, 0 run </li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:45 PM<span> </span></span>
                       
                       <div class="col-1 text-right lakshman"> 
                       </div>
                      </ul>
                                <ul class="list-inline bbb-row" id="ballid_651571">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651577">
                   ...
                   <li class="col3">
                                    Mujtaba J to Usman A<strong> WIDE</strong></li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:46 PM<span> </span></span>
                       
                       <div class="col-1 text-right lakshman"> 
                       </div>
                      </ul>
                                <ul class="list-inline bbb-row" id="ballid_651580">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651583">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <div class="end-over">
                                       ...
                                       <div class="col-sm-10 sp">
                                              <div class="end-red">
                                                  <div class="row">
                                                      <div class="col-sm-3 col-xs-6 sp"> 
                                                          <div class="end-head" style="text-align: left;">                                                           
                                                              <p style="line-height: 1.85">Over 4  
                                                                   (4 Runs)</p>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4 col-xs-12 sp over-ending">  
                                                          <div class="end-test">
                                                          <p style="line-height: 1.85">Usman A<span style="float: right;"> 3 (9)</span></p>
                                                               <p style="line-height: 1.85"> Atanu B<span style="float: right;"> 14 (15)</span> </p>
                                                                </div>
                                                        </div>
                                                        <div class="col-sm-5 col-xs-12 sp"> 
                                                          <div class="end-test">
                                                                <p style="line-height: 1.85">Mujtaba J<span style="float: right;"> 2.0-0-10-0</span> </p>
                                                              <p style="line-height: 1.85" class="hidden-phone">Run Rate : <span style="float: right"> 4.75</span>
                                                              </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-sm-2 sp">
                                              <div class="end-head sp">
                                                <table style="width: 100%"><tbody><tr><td>
                                                    <h4 class="hidden-phone">TOR</h4>
                                                    <h4 class="show-phone">Toronto Jaguars</h4>
                                                    <h4><span>19/0</span></h4>
                                                    </td><td style="text-align: right;"><label class="show-phone" style="font-size: 14px;color: white;">Run Rate : 4.75</label></td></tr></tbody></table>
                                                </div>
                                    ...
                                    <ul class="list-inline bbb-row" id="ballid_651586">
                   ...
                   <li class="col3">
                                     (4) Muhammad Salman Arshad, comes into the attack</li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:47 PM<span> </span></span>
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651590">
                   ...
                   <li class="col3">
                                    Muhammad Salman A to Atanu B, 2 runs </li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:48 PM<span> </span></span>
                       
                       <div class="col-1 text-right lakshman"> 
                       </div>
                      </ul>
                                <ul class="list-inline bbb-row" id="ballid_651594">
                   ...
                   <li class="col3">
                                    Muhammad Salman A to Usman A<strong> WIDE</strong></li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:48 PM<span> </span></span>
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651596">
                   ...
                   <li class="col3">
                                    Muhammad Salman A to Usman A, 1 run </li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:49 PM<span> </span></span>
                       
                       <div class="col-1 text-right lakshman"> 
                       </div>
                      </ul>
                                <ul class="list-inline bbb-row" id="ballid_651599">
                   ...
                   <li class="col3">
                                    Muhammad Salman A to Atanu B, 0 run </li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:49 PM<span> </span></span>
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651602">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651604">
                   ...
                   <li class="col3">
                     ...
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:50 PM<span> </span></span>
                       
                       <div class="col-1 text-right lakshman"> 
                       </div>
                      </ul>
                                <ul class="list-inline bbb-row" id="ballid_651609">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <div class="end-over">
                                       ...
                                       <div class="col-sm-10 sp">
                                              <div class="end-red">
                                                  <div class="row">
                                                      <div class="col-sm-3 col-xs-6 sp"> 
                                                          <div class="end-head" style="text-align: left;">                                                           
                                                              <p style="line-height: 1.85">Over 5  
                                                                   (7 Runs)</p>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4 col-xs-12 sp over-ending">  
                                                          <div class="end-test">
                                                          <p style="line-height: 1.85">Usman A<span style="float: right;"> 5 (11)</span></p>
                                                               <p style="line-height: 1.85"> Atanu B<span style="float: right;"> 18 (19)</span> </p>
                                                                </div>
                                                        </div>
                                                        <div class="col-sm-5 col-xs-12 sp"> 
                                                          <div class="end-test">
                                                                <p style="line-height: 1.85">Muhammad Salm<span style="float: right;"> 1.0-0-7-0</span> </p>
                                                              <p style="line-height: 1.85" class="hidden-phone">Run Rate : <span style="float: right"> 5.20</span>
                                                              </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-sm-2 sp">
                                              <div class="end-head sp">
                                                <table style="width: 100%"><tbody><tr><td>
                                                    <h4 class="hidden-phone">TOR</h4>
                                                    <h4 class="show-phone">Toronto Jaguars</h4>
                                                    <h4><span>26/0</span></h4>
                                                    </td><td style="text-align: right;"><label class="show-phone" style="font-size: 14px;color: white;">Run Rate : 5.20</label></td></tr></tbody></table>
                                                </div>
                                    ...
                                    <ul class="list-inline bbb-row" id="ballid_651612">
                   ...
                   <li class="col3">
                                     (72) Abdullah Abbas, comes into the attack</li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:51 PM<span> </span></span>
                       
                       <div class="col-1 text-right lakshman"> 
                       </div>
                      </ul>
                                <ul class="list-inline bbb-row" id="ballid_651615">
                   ...
                   <li class="col3">
                                    Abdullah A to Atanu B, 1 run </li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:51 PM<span> </span></span>
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651618">
                   ...
                   <li class="col3">
                                    Abdullah A to Atanu B, 0 run </li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:52 PM<span> </span></span>
                       
                       <div class="col-1 text-right lakshman"> 
                       </div>
                      </ul>
                                <ul class="list-inline bbb-row" id="ballid_651619">
                   ...
                   <li class="col3">
                                    Abdullah A to Atanu B, 2 runs </li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:52 PM<span> </span></span>
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651622">
                              
                  
                   <li class="col2">
                                <span class="runs">6</span>
                                  <span class="ov" style="padding-left: 5px;">
                   ...
                   <li class="col3">
                                    Abdullah A to Usman A, 6 runs <strong> SIX</strong></li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:52 PM<span> </span></span>
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651626">
                   ...
                   <li class="col3">
                                    Abdullah A to Usman A, 1 run </li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:53 PM<span> </span></span>
                       
                       <div class="col-1 text-right lakshman"> 
                       </div>
                      </ul>
                                <ul class="list-inline bbb-row" id="ballid_651628">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <div class="end-over">
                                       ...
                                       <div class="col-sm-10 sp">
                                              <div class="end-red">
                                                  <div class="row">
                                                      <div class="col-sm-3 col-xs-6 sp"> 
                                                          <div class="end-head" style="text-align: left;">                                                           
                                                              <p style="line-height: 1.85">Over 6  
                                                                   (12 Runs)</p>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4 col-xs-12 sp over-ending">  
                                                          <div class="end-test">
                                                          <p style="line-height: 1.85">Atanu B<span style="float: right;"> 23 (23)</span></p>
                                                               <p style="line-height: 1.85"> Usman A<span style="float: right;"> 12 (13)</span> </p>
                                                                </div>
                                                        </div>
                                                        <div class="col-sm-5 col-xs-12 sp"> 
                                                          <div class="end-test">
                                                                <p style="line-height: 1.85">Abdullah A<span style="float: right;"> 1.0-0-12-0</span> </p>
                                                              <p style="line-height: 1.85" class="hidden-phone">Run Rate : <span style="float: right"> 6.33</span>
                                                              </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-sm-2 sp">
                                              <div class="end-head sp">
                                                <table style="width: 100%"><tbody><tr><td>
                                                    <h4 class="hidden-phone">TOR</h4>
                                                    <h4 class="show-phone">Toronto Jaguars</h4>
                                                    <h4><span>38/0</span></h4>
                                                    </td><td style="text-align: right;"><label class="show-phone" style="font-size: 14px;color: white;">Run Rate : 6.33</label></td></tr></tbody></table>
                                                </div>
                                    ...
                                    <ul class="list-inline bbb-row" id="ballid_651630">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651634">
                   ...
                   <li class="col3">
                                    Muhammad Salman A to Atanu B, 4 runs <strong> FOUR</strong></li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:54 PM<span> </span></span>
                       
                       <div class="col-1 text-right lakshman"> 
                       </div>
                      </ul>
                                <ul class="list-inline bbb-row" id="ballid_651638">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651643">
                   ...
                   <li class="col3">
                                    Muhammad Salman A to Usman A, 0 run </li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:55 PM<span> </span></span>
                       
                       <div class="col-1 text-right lakshman"> 
                       </div>
                      </ul>
                                <ul class="list-inline bbb-row" id="ballid_651650">
                              
                  
                   <li class="col2">
                                <span class="runs" style="padding: 11px 10px;">1W</span>
                                  <span class="ov" style="padding-left: 5px;">
                   ...
                   <li class="col3">
                                    Muhammad Salman A to Usman A, 1 run <strong> OUT!</strong> 
                     
                     <strong>RUN OUT &nbsp;</strong>            
                       <p>
                      
                      <strong><a target="_new" href="/MississaugaCricketLeague/viewPlayer.do?playerId=1367221&amp;clubId=2565">Usman Aziz&nbsp;</a>
                                run out (<a href="viewPlayer.do?playerId=1036746&amp;clubId=2565">Muhammad Salman A</a>) &nbsp; 
                                13</strong> 
                                (15b  0 Fours, 1 Sixers)
                                SR 86.67</p></li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:56 PM<span> </span></span>
                       
                       <div class="col-1 text-right lakshman"> 
                       </div>
                      </ul>
                                <ul class="list-inline bbb-row" id="ballid_651651">
                   ...
                   <li class="col3">
                                     Ramkiran Nersu, comes to the crease.</li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:56 PM<span> </span></span>
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651657">
                   ...
                   <li class="col3">
                                    Muhammad Salman A to Ramkiran N<strong> WIDE</strong></li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:57 PM<span> </span></span>
                       
                       <div class="col-1 text-right lakshman"> 
                       </div>
                      </ul>
                                <ul class="list-inline bbb-row" id="ballid_651662">
                   ...
                   <li class="col3">
                                    Muhammad Salman A to Ramkiran N, 2 runs </li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:57 PM<span> </span></span>
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651665">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <div class="end-over">
                                       ...
                                       <div class="col-sm-10 sp">
                                              <div class="end-red">
                                                  <div class="row">
                                                      <div class="col-sm-3 col-xs-6 sp"> 
                                                          <div class="end-head" style="text-align: left;">                                                           
                                                              <p style="line-height: 1.85">Over 7  
                                                                   (12 Runs)</p>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4 col-xs-12 sp over-ending">  
                                                          <div class="end-test">
                                                          <p style="line-height: 1.85">Atanu B<span style="float: right;"> 31 (26)</span></p>
                                                               <p style="line-height: 1.85"> Ramkiran N<span style="float: right;"> 2 (1)</span> </p>
                                                                </div>
                                                        </div>
                                                        <div class="col-sm-5 col-xs-12 sp"> 
                                                          <div class="end-test">
                                                                <p style="line-height: 1.85">Muhammad Salm<span style="float: right;"> 2.0-0-19-0</span> </p>
                                                              <p style="line-height: 1.85" class="hidden-phone">Run Rate : <span style="float: right"> 7.14</span>
                                                              </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-sm-2 sp">
                                              <div class="end-head sp">
                                                <table style="width: 100%"><tbody><tr><td>
                                                    <h4 class="hidden-phone">TOR</h4>
                                                    <h4 class="show-phone">Toronto Jaguars</h4>
                                                    <h4><span>50/1</span></h4>
                                                    </td><td style="text-align: right;"><label class="show-phone" style="font-size: 14px;color: white;">Run Rate : 7.14</label></td></tr></tbody></table>
                                                </div>
                                    ...
                                    <ul class="list-inline bbb-row" id="ballid_651668">
                   ...
                   <li class="col3">
                                     Imran Samdani, comes into the attack</li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:58 PM<span> </span></span>
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651677">
                   ...
                   <li class="col3">
                                    Imran S to Atanu B<strong> WIDE</strong></li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					8:59 PM<span> </span></span>
                       
                       <div class="col-1 text-right lakshman"> 
                       </div>
                      </ul>
                                <ul class="list-inline bbb-row" id="ballid_651683">
                   ...
                   <li class="col3">
                                    Imran S to Atanu B, 0 run </li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					9:00 PM<span> </span></span>
                       
                       <div class="col-1 text-right lakshman"> 
                       </div>
                      </ul>
                                <ul class="list-inline bbb-row" id="ballid_651684">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651688">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651690">
                   ...
                   <li class="col3">
                                    Imran S to Ramkiran N, 0 run </li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					9:00 PM<span> </span></span>
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651694">
                   ...
                   <li class="col3">
                                    Imran S to Ramkiran N, 2 runs </li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					9:01 PM<span> </span></span>
                       
                       <div class="col-1 text-right lakshman"> 
                       </div>
                      </ul>
                                <ul class="list-inline bbb-row" id="ballid_651697">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <div class="end-over">
                                       ...
                                       <div class="col-sm-10 sp">
                                              <div class="end-red">
                                                  <div class="row">
                                                      <div class="col-sm-3 col-xs-6 sp"> 
                                                          <div class="end-head" style="text-align: left;">                                                           
                                                              <p style="line-height: 1.85">Over 8  
                                                                   (7 Runs)</p>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4 col-xs-12 sp over-ending">  
                                                          <div class="end-test">
                                                          <p style="line-height: 1.85">Atanu B<span style="float: right;"> 35 (30)</span></p>
                                                               <p style="line-height: 1.85"> Ramkiran N<span style="float: right;"> 4 (3)</span> </p>
                                                                </div>
                                                        </div>
                                                        <div class="col-sm-5 col-xs-12 sp"> 
                                                          <div class="end-test">
                                                                <p style="line-height: 1.85">Imran S<span style="float: right;"> 1.0-0-7-0</span> </p>
                                                              <p style="line-height: 1.85" class="hidden-phone">Run Rate : <span style="float: right"> 7.12</span>
                                                              </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-sm-2 sp">
                                              <div class="end-head sp">
                                                <table style="width: 100%"><tbody><tr><td>
                                                    <h4 class="hidden-phone">TOR</h4>
                                                    <h4 class="show-phone">Toronto Jaguars</h4>
                                                    <h4><span>57/1</span></h4>
                                                    </td><td style="text-align: right;"><label class="show-phone" style="font-size: 14px;color: white;">Run Rate : 7.12</label></td></tr></tbody></table>
                                                </div>
                                    ...
                                    <ul class="list-inline bbb-row" id="ballid_651699">
                   ...
                   <li class="col3">
                     ...
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					9:02 PM<span> </span></span>
                       
                       <div class="col-1 text-right lakshman"> 
                       </div>
                      </ul>
                                <ul class="list-inline bbb-row" id="ballid_651702">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651705">
                   ...
                   <li class="col3">
                                    Abdullah A to Ramkiran N, 2 runs </li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					9:02 PM<span> </span></span>
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651707">
                   ...
                   <li class="col3">
                     ...
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					9:03 PM<span> </span></span>
                       
                       <div class="col-1 text-right lakshman"> 
                       </div>
                      </ul>
                                <ul class="list-inline bbb-row" id="ballid_651711">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651714">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651717">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <div class="end-over">
                                       ...
                                       <div class="col-sm-10 sp">
                                              <div class="end-red">
                                                  <div class="row">
                                                      <div class="col-sm-3 col-xs-6 sp"> 
                                                          <div class="end-head" style="text-align: left;">                                                           
                                                              <p style="line-height: 1.85">Over 9  
                                                                   (9 Runs)</p>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4 col-xs-12 sp over-ending">  
                                                          <div class="end-test">
                                                          <p style="line-height: 1.85">Atanu B<span style="float: right;"> 40 (34)</span></p>
                                                               <p style="line-height: 1.85"> Ramkiran N<span style="float: right;"> 8 (5)</span> </p>
                                                                </div>
                                                        </div>
                                                        <div class="col-sm-5 col-xs-12 sp"> 
                                                          <div class="end-test">
                                                                <p style="line-height: 1.85">Abdullah A<span style="float: right;"> 2.0-0-21-0</span> </p>
                                                              <p style="line-height: 1.85" class="hidden-phone">Run Rate : <span style="float: right"> 7.33</span>
                                                              </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-sm-2 sp">
                                              <div class="end-head sp">
                                                <table style="width: 100%"><tbody><tr><td>
                                                    <h4 class="hidden-phone">TOR</h4>
                                                    <h4 class="show-phone">Toronto Jaguars</h4>
                                                    <h4><span>66/1</span></h4>
                                                    </td><td style="text-align: right;"><label class="show-phone" style="font-size: 14px;color: white;">Run Rate : 7.33</label></td></tr></tbody></table>
                                                </div>
                                    ...
                                    <ul class="list-inline bbb-row" id="ballid_651719">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651724">
                   ...
                   <li class="col3">
                                    Imran S to Ramkiran N, 1 run </li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					9:05 PM<span> </span></span>
                       
                       <div class="col-1 text-right lakshman"> 
                       </div>
                      </ul>
                                <ul class="list-inline bbb-row" id="ballid_651726">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651731">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651734">
                   ...
                   <li class="col3">
                                    Imran S to Atanu B, 6 runs <strong> SIX</strong></li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					9:06 PM<span> </span></span>
                       
                       <div class="col-1 text-right lakshman"> 
                       </div>
                      </ul>
                                <ul class="list-inline bbb-row" id="ballid_651737">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651741">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <div class="end-over">
                                       ...
                                       <div class="col-sm-10 sp">
                                              <div class="end-red">
                                                  <div class="row">
                                                      <div class="col-sm-3 col-xs-6 sp"> 
                                                          <div class="end-head" style="text-align: left;">                                                           
                                                              <p style="line-height: 1.85">Over 10  
                                                                   (12 Runs)</p>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4 col-xs-12 sp over-ending">  
                                                          <div class="end-test">
                                                          <p style="line-height: 1.85">Atanu B<span style="float: right;"> 49 (38)</span></p>
                                                               <p style="line-height: 1.85"> Ramkiran N<span style="float: right;"> 11 (7)</span> </p>
                                                                </div>
                                                        </div>
                                                        <div class="col-sm-5 col-xs-12 sp"> 
                                                          <div class="end-test">
                                                                <p style="line-height: 1.85">Imran S<span style="float: right;"> 2.0-0-19-0</span> </p>
                                                              <p style="line-height: 1.85" class="hidden-phone">Run Rate : <span style="float: right"> 7.80</span>
                                                              </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-sm-2 sp">
                                              <div class="end-head sp">
                                                <table style="width: 100%"><tbody><tr><td>
                                                    <h4 class="hidden-phone">TOR</h4>
                                                    <h4 class="show-phone">Toronto Jaguars</h4>
                                                    <h4><span>78/1</span></h4>
                                                    </td><td style="text-align: right;"><label class="show-phone" style="font-size: 14px;color: white;">Run Rate : 7.80</label></td></tr></tbody></table>
                                                </div>
                                    ...
                                    <ul class="list-inline bbb-row" id="ballid_651745">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651749">
                              
                  
                   <li class="col2">
                                <span class="runs" style="padding: 11px 10px;">1lb</span>
                                  <span class="ov" style="padding-left: 5px;">
                   ...
                   <li class="col3">
                                    Irfan S to Ramkiran N, 1 run <strong> LEG BYE</strong></li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					9:08 PM<span> </span></span>
                       
                       <div class="col-1 text-right lakshman"> 
                       </div>
                      </ul>
                                <ul class="list-inline bbb-row" id="ballid_651751">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651755">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651756">
                   ...
                   <li class="col3">
                     ...
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					9:09 PM<span> </span></span>
                       
                       <div class="col-1 text-right lakshman"> 
                       </div>
                      </ul>
                                <ul class="list-inline bbb-row" id="ballid_651759">
                              
                  
                   <li class="col2">
                                <span class="wicket">W</span>
                                  <span class="ov" style="padding-left: 5px;">
                   ...
                   <li class="col3">
                                    Irfan S to Atanu B<strong> OUT!</strong> 
                     
                     <strong>BOWLED &nbsp;</strong>            
                       <p>
                      
                      <strong><a target="_new" href="/MississaugaCricketLeague/viewPlayer.do?playerId=2093443&amp;clubId=2565">Atanu Bharali&nbsp;</a>
                                b <a href="viewPlayer.do?playerId=2674040&amp;clubId=2565">Irfan S</a>&nbsp; 
                                49</strong> 
                                (41b  2 Fours, 1 Sixers)
                                SR 119.51</p></li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					9:09 PM<span> </span></span>
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651763">
                   ...
                   <li class="col3">
                                     Imran Nahid, comes to the crease.</li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					9:10 PM<span> </span></span>
                       
                       <div class="col-1 text-right lakshman"> 
                       </div>
                      </ul>
                                <ul class="list-inline bbb-row" id="ballid_651766">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651769">
                   ...
                   <li class="col3">
                                    Irfan S to Ramkiran N<strong> WIDE</strong></li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					9:10 PM<span> </span></span>
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651774">
                   ...
                   <li class="col3">
                                    Irfan S to Ramkiran N, 0 run </li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					9:11 PM<span> </span></span>
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <div class="end-over">
                                       ...
                                       <div class="col-sm-10 sp">
                                              <div class="end-red">
                                                  <div class="row">
                                                      <div class="col-sm-3 col-xs-6 sp"> 
                                                          <div class="end-head" style="text-align: left;">                                                           
                                                              <p style="line-height: 1.85">Over 11  
                                                                   (5 Runs)</p>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4 col-xs-12 sp over-ending">  
                                                          <div class="end-test">
                                                          <p style="line-height: 1.85">Ramkiran N<span style="float: right;"> 11 (9)</span></p>
                                                               <p style="line-height: 1.85"> Imran N<span style="float: right;"> 2 (1)</span> </p>
                                                                </div>
                                                        </div>
                                                        <div class="col-sm-5 col-xs-12 sp"> 
                                                          <div class="end-test">
                                                                <p style="line-height: 1.85">Irfan S<span style="float: right;"> 3.0-0-13-1</span> </p>
                                                              <p style="line-height: 1.85" class="hidden-phone">Run Rate : <span style="float: right"> 7.55</span>
                                                              </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-sm-2 sp">
                                              <div class="end-head sp">
                                                <table style="width: 100%"><tbody><tr><td>
                                                    <h4 class="hidden-phone">TOR</h4>
                                                    <h4 class="show-phone">Toronto Jaguars</h4>
                                                    <h4><span>83/2</span></h4>
                                                    </td><td style="text-align: right;"><label class="show-phone" style="font-size: 14px;color: white;">Run Rate : 7.55</label></td></tr></tbody></table>
                                                </div>
                                    ...
                                    <ul class="list-inline bbb-row" id="ballid_651776">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651778">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651781">
                   ...
                   <li class="col3">
                                    Mujtaba J to Imran N, 1 run <strong> LEG BYE</strong></li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					9:12 PM<span> </span></span>
                       
                       <div class="col-1 text-right lakshman"> 
                       </div>
                      </ul>
                                <ul class="list-inline bbb-row" id="ballid_651783">
                              
                  
                   <li class="col2">
                                <span class="runs" style="padding: 11px 10px;">2wd</span>
                                  <span class="ov" style="padding-left: 5px;">
                   ...
                   <li class="col3">
                                    Mujtaba J to Ramkiran N<strong> 2 WIDES</strong></li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					9:12 PM<span> </span></span>
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651785">
                   ...
                   <li class="col3">
                     ...
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					9:13 PM<span> </span></span>
                       
                       <div class="col-1 text-right lakshman"> 
                       </div>
                      </ul>
                                <ul class="list-inline bbb-row" id="ballid_651787">
                   ...
                   <li class="col3">
                                    Mujtaba J to Imran N, 2 runs </li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					9:13 PM<span> </span></span>
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651790">
                   ...
                   <li class="col3">
                                    Mujtaba J to Ramkiran N<strong> WIDE</strong></li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					9:14 PM<span> </span></span>
                       
                       <div class="col-1 text-right lakshman"> 
                       </div>
                      </ul>
                                <ul class="list-inline bbb-row" id="ballid_651792">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
                       ...
                       <div class="col-1 text-right lakshman"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651795">
                   ...
                   <li class="col3">
                                    Mujtaba J to Ramkiran N, 0 run </li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					9:15 PM<span> </span></span>
                       
                       <div class="col-1 text-right lakshman"> 
                       </div>
                      </ul>
                                <ul class="list-inline bbb-row" id="ballid_651800">
                   ...
                   <li class="col3">
                                    Mujtaba J to Ramkiran N, 1 run </li>
                     <span class="hidden-phone" style="float: right; font-size:14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i> 
    					9:16 PM<span> </span></span>
                                       ...
                                       <div class="col-sm-10 sp">
                                              <div class="end-red">
                                                  <div class="row">
                                                      <div class="col-sm-3 col-xs-6 sp"> 
                                                          <div class="end-head" style="text-align: left;">                                                           
                                                              <p style="line-height: 1.85">Over 12  
                                                                   (8 Runs)</p>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4 col-xs-12 sp over-ending">  
                                                        ...
                                                        <div class="col-sm-5 col-xs-12 sp"> 
                                                          <div class="end-test">
                                                              ...
                                                              <p style="line-height: 1.85" class="hidden-phone">Run Rate : <span style="float: right"> 7.58</span>
                                                              </p>
                                                            </div>
                                                        </div>
                                                    </div>
              ...
              <div class="tab-pane active" id="ballByBallTeam2">
            
                              <div class="ball-by-ball-section">
                           <ul class="list-inline bbb-row" id="ballid_651814">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                   (4) Muhammad Salman Arshad, comes to the crease.</li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:18 PM<span> </span></span>
                       
                     <div class="col-1 text-right"> 
                     </div>
  </ul>
                                <ul class="list-inline bbb-row" id="ballid_651816">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                   Mubashir Jawed, comes to the crease.</li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:18 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651817">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                   Imran Nahid, comes into the attack</li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:18 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651823">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                  Imran N to Muhammad Salman A, 2 runs </li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:20 PM<span> </span></span>
                       
                     <div class="col-1 text-right"> 
                     </div>
  </ul>
                                <ul class="list-inline bbb-row" id="ballid_651825">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                  Imran N to Mubashir J, 0 run </li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:20 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651827">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                  Imran N to Mubashir J, 1 run </li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:21 PM<span> </span></span>
                       
                     <div class="col-1 text-right"> 
                     </div>
  </ul>
                                <ul class="list-inline bbb-row" id="ballid_651828">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                  Imran N to Mubashir J<strong> WIDE</strong></li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:21 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651830">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                  Imran N to Mubashir J, 2 runs </li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:22 PM<span> </span></span>
                       
                     <div class="col-1 text-right"> 
                     </div>
  </ul>
                                <ul class="list-inline bbb-row" id="ballid_651834">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:22 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651836">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                                ...
                                <div class="end-over">
                                      <div class="row"> 
                                       <div class="col-sm-10 sp">
                                              <div class="end-red">
                                                  <div class="row">
                                                      <div class="col-sm-3 sp col-xs-6">  
                                                          <div class="end-head" style="text-align: left;">                                                          
                                                              <p style="line-height: 1.85">Over 1  
                                                                   (8 Runs)</p>
                                                            </div>
                                                         ...
                                                         <div class="col-sm-4 col-xs-12 sp over-ending">
                                                          <div class="end-test">
                                                          <p style="line-height: 1.85">Mubashir J<span style="float: right;">3 (4)</span> </p>
                                                               <p style="line-height: 1.85"> Muhammad Salm<span style="float: right;"> 4 (2)</span> </p>
                                                                </div>
                                                        </div>
                                                        <div class="col-sm-5 col-xs-12 sp"> 
                                                          <div class="end-test">
                                                                <p style="line-height: 1.85">Imran N<span style="float: right;">1.0-0-8-0</span> </p>
                                                              <p style="line-height: 1.85" class="hidden-phone">Run Rate : <span style="float: right"> 8.00</span>
                                                              </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-sm-2 sp">
                                              <div class="end-head sp">
                                                <table style="width: 100%"><tbody><tr><td>
                                                    <h4 class="hidden-phone">RTC</h4>
                                                    <h4 class="show-phone">Royal Tigers</h4>
                                                    <h4><span>8/0</span></h4>
                                                    </td><td style="text-align: right;"><label class="show-phone" style="font-size: 14px;color: white;">Run Rate : 8.00</label></td></tr></tbody></table>
                                                </div>
                                      ...
                                      <ul class="list-inline bbb-row">
                                             <li class="commr"><p><i class="fa fa-comments-o"></i> <strong>84 runs needed in 11.0 overs (66 balls) with 10 wickets remaining. RRR: 7.64</strong></p></li>
                                      </ul>
                                     </div>
                                  <ul class="list-inline bbb-row" id="ballid_651837">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                   Gurpreet Singh, comes into the attack</li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:23 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651839">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                  Gurpreet S to Muhammad Salman A, 2 runs </li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:24 PM<span> </span></span>
                       
                     <div class="col-1 text-right"> 
                     </div>
  </ul>
                                <ul class="list-inline bbb-row" id="ballid_651842">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                  Gurpreet S to Mubashir J, 1 run </li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:24 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651844">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                  Gurpreet S to Muhammad Salman A, 1 run </li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:25 PM<span> </span></span>
                       
                     <div class="col-1 text-right"> 
                     </div>
  </ul>
                                <ul class="list-inline bbb-row" id="ballid_651847">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:25 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651851">
          ...
          <li class="col2">     
                  ...
                  Gurpreet S to Muhammad Salman A, 1 run </li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:26 PM<span> </span></span>
                       
                     <div class="col-1 text-right"> 
                     </div>
  </ul>
                                <ul class="list-inline bbb-row" id="ballid_651854">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                  Gurpreet S to Mubashir J, 0 run </li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:27 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <div class="end-over">
                                              ...
                                              <div class="end-red">
                                                  <div class="row">
                                                      <div class="col-sm-3 sp col-xs-6">  
                                                         ...
                                                         <div class="col-sm-4 col-xs-12 sp over-ending">
                                                          <div class="end-test">
                                                          <p style="line-height: 1.85">Mubashir J<span style="float: right;">4 (6)</span> </p>
                                                               <p style="line-height: 1.85"> Muhammad Salm<span style="float: right;"> 9 (6)</span> </p>
                                                                </div>
                                                        </div>
                                                        <div class="col-sm-5 col-xs-12 sp"> 
                                                          <div class="end-test">
                                                                <p style="line-height: 1.85">Gurpreet S<span style="float: right;">1.0-0-6-0</span> </p>
                                                              <p style="line-height: 1.85" class="hidden-phone">Run Rate : <span style="float: right"> 7.00</span>
                                                              </p>
                                                            </div>
                                                        </div>
                                      ...
                                      <div class="summary-list">
                                      <ul class="list-inline bbb-row">
                                             <li class="commr"><p><i class="fa fa-comments-o"></i> <strong>78 runs needed in 10.0 overs (60 balls) with 10 wickets remaining. RRR: 7.80</strong></p></li>
                                      </ul>
                                     </div>
                                  <ul class="list-inline bbb-row" id="ballid_651855">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:27 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651860">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:27 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651863">
          ...
          <li class="col2">     
                  ...
                  Imran N to Mubashir J, 0 run </li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:28 PM<span> </span></span>
                       
                     <div class="col-1 text-right"> 
                     </div>
  </ul>
                                <ul class="list-inline bbb-row" id="ballid_651866">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:28 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651869">
          ...
          <li class="col2">     
                  ...
                  Imran N to Mubashir J, 2 runs </li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:29 PM<span> </span></span>
                       
                     <div class="col-1 text-right"> 
                     </div>
  </ul>
                                <ul class="list-inline bbb-row" id="ballid_651874">
          ...
          <li class="col2">     
                  ...
                  Imran N to Muhammad Salman A, 2 runs </li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:30 PM<span> </span></span>
                       
                     <div class="col-1 text-right"> 
                     </div>
  </ul>
                                <ul class="list-inline bbb-row" id="ballid_651880">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:31 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <div class="end-over">
                                              ...
                                              <div class="end-red">
                                                  <div class="row">
                                                      <div class="col-sm-3 sp col-xs-6">  
                                                         ...
                                                         <div class="col-sm-4 col-xs-12 sp over-ending">
                                                          <div class="end-test">
                                                          <p style="line-height: 1.85">Mubashir J<span style="float: right;">6 (10)</span> </p>
                                                               <p style="line-height: 1.85"> Muhammad Salm<span style="float: right;"> 13 (8)</span> </p>
                                                                </div>
                                                        </div>
                                                        <div class="col-sm-5 col-xs-12 sp"> 
                                                          <div class="end-test">
                                                                <p style="line-height: 1.85">Imran N<span style="float: right;">2.0-0-14-0</span> </p>
                                                              <p style="line-height: 1.85" class="hidden-phone">Run Rate : <span style="float: right"> 6.67</span>
                                                              </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-sm-2 sp">
                                              <div class="end-head sp">
                                                <table style="width: 100%"><tbody><tr><td>
                                                    ...
                                                    </td><td style="text-align: right;"><label class="show-phone" style="font-size: 14px;color: white;">Run Rate : 6.67</label></td></tr></tbody></table>
                                                </div>
                                      ...
                                      <div class="summary-list">
                                      <ul class="list-inline bbb-row">
                                             <li class="commr"><p><i class="fa fa-comments-o"></i> <strong>72 runs needed in 9.0 overs (54 balls) with 10 wickets remaining. RRR: 8.00</strong></p></li>
                                      </ul>
                                     </div>
                                  <ul class="list-inline bbb-row" id="ballid_651884">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                   (72) Mohammedi, comes into the attack</li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:31 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651887">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                  Mohammedi to Muhammad Salman A<strong> WIDE</strong></li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:31 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651890">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                  Mohammedi to Muhammad Salman A, 1 run </li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:32 PM<span> </span></span>
                       
                     <div class="col-1 text-right"> 
                     </div>
  </ul>
                                <ul class="list-inline bbb-row" id="ballid_651893">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                  Mohammedi to Muhammad Salman A, 2 runs </li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:32 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651896">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                  Mohammedi to Mubashir J, 4 runs <strong> FOUR</strong></li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:33 PM<span> </span></span>
                       
                     <div class="col-1 text-right"> 
                     </div>
  </ul>
                                <ul class="list-inline bbb-row" id="ballid_651898">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                  Mohammedi to Mubashir J, 1 run </li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:33 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651901">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                  Mohammedi to Mubashir J, 6 runs <strong> SIX</strong></li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:34 PM<span> </span></span>
                       
                     <div class="col-1 text-right"> 
                     </div>
  </ul>
                                <ul class="list-inline bbb-row" id="ballid_651903">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                  Mohammedi to Mubashir J<strong> WIDE</strong></li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:34 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651906">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                  Mohammedi to Mubashir J, 2 runs </li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:34 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <div class="end-over">
                                              ...
                                              <div class="end-red">
                                                  <div class="row">
                                                      <div class="col-sm-3 sp col-xs-6">  
                                                         ...
                                                         <div class="col-sm-4 col-xs-12 sp over-ending">
                                                          <div class="end-test">
                                                          <p style="line-height: 1.85">Mubashir J<span style="float: right;">19 (14)</span> </p>
                                                               <p style="line-height: 1.85"> Muhammad Salm<span style="float: right;"> 16 (10)</span> </p>
                                                                </div>
                                                        </div>
                                                        <div class="col-sm-5 col-xs-12 sp"> 
                                                          <div class="end-test">
                                                                <p style="line-height: 1.85">Mohammedi<span style="float: right;">1.0-0-18-0</span> </p>
                                                              <p style="line-height: 1.85" class="hidden-phone">Run Rate : <span style="float: right"> 9.50</span>
                                                              </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-sm-2 sp">
                                              <div class="end-head sp">
                                                <table style="width: 100%"><tbody><tr><td>
                                                    ...
                                                    <h4 class="show-phone">Royal Tigers</h4>
                                                    <h4><span>38/0</span></h4>
                                                    </td><td style="text-align: right;"><label class="show-phone" style="font-size: 14px;color: white;">Run Rate : 9.50</label></td></tr></tbody></table>
                                                </div>
                                      ...
                                      <div class="summary-list">
                                      <ul class="list-inline bbb-row">
                                             <li class="commr"><p><i class="fa fa-comments-o"></i> <strong>54 runs needed in 8.0 overs (48 balls) with 10 wickets remaining. RRR: 6.75</strong></p></li>
                                      </ul>
                                     </div>
                                  <ul class="list-inline bbb-row" id="ballid_651909">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                   Adeel Ali, comes into the attack</li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:35 PM<span> </span></span>
                       
                     <div class="col-1 text-right"> 
                     </div>
  </ul>
                                <ul class="list-inline bbb-row" id="ballid_651912">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                  Adeel A to Mubashir J, 1 run </li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:35 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651914">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                  Adeel A to Muhammad Salman A, 2 runs </li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:36 PM<span> </span></span>
                       
                     <div class="col-1 text-right"> 
                     </div>
  </ul>
                                <ul class="list-inline bbb-row" id="ballid_651915">
                   
                              
                  
          <li class="col2">     
                                <span class="runs" style="padding: 11px 10px;">1b</span>
                                  <span class="ov" style="padding-left: 5px;">
                                    
                                     4.3</span> &nbsp;
                                       </li>
                    <li class="col3">
                  Adeel A to Mubashir J, 1 run <strong> BYE</strong></li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:36 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651919">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                  Adeel A to Muhammad Salman A, 0 run </li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:37 PM<span> </span></span>
                       
                     <div class="col-1 text-right"> 
                     </div>
  </ul>
                                <ul class="list-inline bbb-row" id="ballid_651922">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                  Adeel A to Muhammad Salman A, 1 run </li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:37 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651924">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                  Adeel A to Muhammad Salman A, 6 runs <strong> SIX</strong></li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:37 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <div class="end-over">
                                              ...
                                              <div class="end-red">
                                                  <div class="row">
                                                      <div class="col-sm-3 sp col-xs-6">  
                                                         ...
                                                         <div class="col-sm-4 col-xs-12 sp over-ending">
                                                          <div class="end-test">
                                                          <p style="line-height: 1.85">Muhammad Salm<span style="float: right;">25 (14)</span> </p>
                                                               <p style="line-height: 1.85"> Mubashir J<span style="float: right;"> 20 (16)</span> </p>
                                                                </div>
                                                        </div>
                                                        <div class="col-sm-5 col-xs-12 sp"> 
                                                          <div class="end-test">
                                                                <p style="line-height: 1.85">Adeel A<span style="float: right;">1.0-0-10-0</span> </p>
                                                              <p style="line-height: 1.85" class="hidden-phone">Run Rate : <span style="float: right"> 9.80</span>
                                                              </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-sm-2 sp">
                                              <div class="end-head sp">
                                                <table style="width: 100%"><tbody><tr><td>
                                                    <h4 class="hidden-phone">RTC</h4>
                                                    <h4 class="show-phone">Royal Tigers</h4>
                                                    <h4><span>49/0</span></h4>
                                                    </td><td style="text-align: right;"><label class="show-phone" style="font-size: 14px;color: white;">Run Rate : 9.80</label></td></tr></tbody></table>
                                                </div>
                                      ...
                                      <div class="summary-list">
                                      <ul class="list-inline bbb-row">
                                             <li class="commr"><p><i class="fa fa-comments-o"></i> <strong>43 runs needed in 7.0 overs (42 balls) with 10 wickets remaining. RRR: 6.14</strong></p></li>
                                      </ul>
                                     </div>
                                  <ul class="list-inline bbb-row" id="ballid_651926">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                   Usman Aziz, comes into the attack</li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:38 PM<span> </span></span>
                       
                     <div class="col-1 text-right"> 
                     </div>
  </ul>
                                <ul class="list-inline bbb-row" id="ballid_651933">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                  Usman A to Mubashir J, 0 run </li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:38 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651935">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                  Usman A to Mubashir J<strong> OUT!</strong> 
                       <strong>STUMPED &nbsp;</strong>
                     <p>
                      <strong><a target="_new" href="/MississaugaCricketLeague/viewPlayer.do?playerId=2259558&amp;clubId=2565">Mubashir Jawed&nbsp;</a>
                                St <a href="viewPlayer.do?playerId=2093443&amp;clubId=2565">Atanu B</a> b <a href="viewPlayer.do?playerId=1367221&amp;clubId=2565">Usman A</a>&nbsp; 
                                20</strong> 
                                (18b  1 Fours, 1 Sixers)
                                SR 111.11</p></li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:39 PM<span> </span></span>
                       
                     <div class="col-1 text-right"> 
                     </div>
  </ul>
                                <ul class="list-inline bbb-row" id="ballid_651939">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                   Noman Siddiqui, comes to the crease.</li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:39 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651941">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:39 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651944">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                  Usman A to Noman S, 6 runs <strong> SIX</strong></li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:40 PM<span> </span></span>
                       
                     <div class="col-1 text-right"> 
                     </div>
  </ul>
                                <ul class="list-inline bbb-row" id="ballid_651946">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:40 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651951">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                  Usman A to Muhammad Salman A, 1 run </li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:41 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <div class="end-over">
                                              ...
                                              <div class="end-red">
                                                  <div class="row">
                                                      <div class="col-sm-3 sp col-xs-6">  
                                                         ...
                                                         <div class="col-sm-4 col-xs-12 sp over-ending">
                                                          <div class="end-test">
                                                          <p style="line-height: 1.85">Muhammad Salm<span style="float: right;">26 (15)</span> </p>
                                                               <p style="line-height: 1.85"> Noman S<span style="float: right;"> 8 (3)</span> </p>
                                                                </div>
                                                        </div>
                                                        <div class="col-sm-5 col-xs-12 sp"> 
                                                          <div class="end-test">
                                                                <p style="line-height: 1.85">Usman A<span style="float: right;">1.0-0-9-1</span> </p>
                                                              <p style="line-height: 1.85" class="hidden-phone">Run Rate : <span style="float: right"> 9.67</span>
                                                              </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-sm-2 sp">
                                              <div class="end-head sp">
                                                <table style="width: 100%"><tbody><tr><td>
                                                    <h4 class="hidden-phone">RTC</h4>
                                                    <h4 class="show-phone">Royal Tigers</h4>
                                                    <h4><span>58/1</span></h4>
                                                    </td><td style="text-align: right;"><label class="show-phone" style="font-size: 14px;color: white;">Run Rate : 9.67</label></td></tr></tbody></table>
                                                </div>
                                      ...
                                      <div class="summary-list">
                                      <ul class="list-inline bbb-row">
                                             <li class="commr"><p><i class="fa fa-comments-o"></i> <strong>34 runs needed in 6.0 overs (36 balls) with 9 wickets remaining. RRR: 5.67</strong></p></li>
                                      </ul>
                                     </div>
                                  <ul class="list-inline bbb-row" id="ballid_651954">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:41 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651958">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                  Gurpreet S to Noman S<strong> WIDE</strong></li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:41 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651960">
          ...
          <li class="col2">     
                  ...
                  Gurpreet S to Noman S<strong> WIDE</strong></li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:42 PM<span> </span></span>
                       
                     <div class="col-1 text-right"> 
                     </div>
  </ul>
                                <ul class="list-inline bbb-row" id="ballid_651965">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                  Gurpreet S to Noman S, 0 run </li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:42 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651968">
          ...
          <li class="col2">     
                  ...
                  Gurpreet S to Noman S, 0 run </li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:43 PM<span> </span></span>
                       
                     <div class="col-1 text-right"> 
                     </div>
  </ul>
                                <ul class="list-inline bbb-row" id="ballid_651972">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:43 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651975">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                  Gurpreet S to Noman S, 2 runs </li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:44 PM<span> </span></span>
                       
                     <div class="col-1 text-right"> 
                     </div>
  </ul>
                                <ul class="list-inline bbb-row" id="ballid_651978">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:44 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651981">
                    ...
                    9:45 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <div class="end-over">
                                              ...
                                              <div class="end-red">
                                                  <div class="row">
                                                      <div class="col-sm-3 sp col-xs-6">  
                                                         ...
                                                         <div class="col-sm-4 col-xs-12 sp over-ending">
                                                          <div class="end-test">
                                                          <p style="line-height: 1.85">Noman S<span style="float: right;">12 (8)</span> </p>
                                                               <p style="line-height: 1.85"> Muhammad Salm<span style="float: right;"> 28 (16)</span> </p>
                                                                </div>
                                                        </div>
                                                        <div class="col-sm-5 col-xs-12 sp"> 
                                                          <div class="end-test">
                                                                <p style="line-height: 1.85">Gurpreet S<span style="float: right;">2.0-0-14-0</span> </p>
                                                              <p style="line-height: 1.85" class="hidden-phone">Run Rate : <span style="float: right"> 9.43</span>
                                                              </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-sm-2 sp">
                                              <div class="end-head sp">
                                                <table style="width: 100%"><tbody><tr><td>
                                                    ...
                                                    <h4 class="show-phone">Royal Tigers</h4>
                                                    <h4><span>66/1</span></h4>
                                                    </td><td style="text-align: right;"><label class="show-phone" style="font-size: 14px;color: white;">Run Rate : 9.43</label></td></tr></tbody></table>
                                                </div>
                                      ...
                                      <div class="summary-list">
                                      <ul class="list-inline bbb-row">
                                             <li class="commr"><p><i class="fa fa-comments-o"></i> <strong>26 runs needed in 5.0 overs (30 balls) with 9 wickets remaining. RRR: 5.20</strong></p></li>
                                      </ul>
                                     </div>
                                  <ul class="list-inline bbb-row" id="ballid_651982">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:45 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651984">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:45 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651989">
          ...
          <li class="col2">     
                  ...
                  Usman A to Noman S, 6 runs <strong> SIX</strong></li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:46 PM<span> </span></span>
                       
                     <div class="col-1 text-right"> 
                     </div>
  </ul>
                                <ul class="list-inline bbb-row" id="ballid_651990">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:46 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651992">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                  Usman A to Noman S<strong> WIDE</strong></li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:46 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_651996">
          ...
          <li class="col2">     
                  ...
                  Usman A to Noman S<strong> WIDE</strong></li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:47 PM<span> </span></span>
                       
                     <div class="col-1 text-right"> 
                     </div>
  </ul>
                                <ul class="list-inline bbb-row" id="ballid_651998">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:47 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_652001">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:47 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_652002">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:47 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <div class="end-over">
                                              ...
                                              <div class="end-red">
                                                  <div class="row">
                                                      <div class="col-sm-3 sp col-xs-6">  
                                                         ...
                                                         <div class="col-sm-4 col-xs-12 sp over-ending">
                                                          <div class="end-test">
                                                          <p style="line-height: 1.85">Noman S<span style="float: right;">21 (14)</span> </p>
                                                               <p style="line-height: 1.85"> Muhammad Salm<span style="float: right;"> 28 (16)</span> </p>
                                                                </div>
                                                        </div>
                                                        <div class="col-sm-5 col-xs-12 sp"> 
                                                          <div class="end-test">
                                                                <p style="line-height: 1.85">Usman A<span style="float: right;">2.0-0-20-1</span> </p>
                                                              <p style="line-height: 1.85" class="hidden-phone">Run Rate : <span style="float: right"> 9.62</span>
                                                              </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-sm-2 sp">
                                              <div class="end-head sp">
                                                <table style="width: 100%"><tbody><tr><td>
                                                    <h4 class="hidden-phone">RTC</h4>
                                                    <h4 class="show-phone">Royal Tigers</h4>
                                                    <h4><span>77/1</span></h4>
                                                    </td><td style="text-align: right;"><label class="show-phone" style="font-size: 14px;color: white;">Run Rate : 9.62</label></td></tr></tbody></table>
                                                </div>
                                      ...
                                      <div class="summary-list">
                                      <ul class="list-inline bbb-row">
                                             <li class="commr"><p><i class="fa fa-comments-o"></i> <strong>15 runs needed in 4.0 overs (24 balls) with 9 wickets remaining. RRR: 3.75</strong></p></li>
                                      </ul>
                                     </div>
                                  <ul class="list-inline bbb-row" id="ballid_652006">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                   Ramkiran Nersu, comes into the attack</li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:48 PM<span> </span></span>
                       
                     <div class="col-1 text-right"> 
                     </div>
  </ul>
                                <ul class="list-inline bbb-row" id="ballid_652008">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                  Ramkiran N to Muhammad Salman A, 0 run </li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:48 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_652009">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                  Ramkiran N to Muhammad Salman A, 1 run </li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:49 PM<span> </span></span>
                       
                     <div class="col-1 text-right"> 
                     </div>
  </ul>
                                <ul class="list-inline bbb-row" id="ballid_652011">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:49 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_652013">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:49 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_652015">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                  Ramkiran N to Muhammad Salman A, 4 runs <strong> FOUR</strong></li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:50 PM<span> </span></span>
                       
                     <div class="col-1 text-right"> 
                     </div>
  </ul>
                                <ul class="list-inline bbb-row" id="ballid_652017">
                    ...
                    9:50 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <div class="end-over">
                                              ...
                                              <div class="end-red">
                                                  <div class="row">
                                                      <div class="col-sm-3 sp col-xs-6">  
                                                         ...
                                                         <div class="col-sm-4 col-xs-12 sp over-ending">
                                                          <div class="end-test">
                                                          <p style="line-height: 1.85">Muhammad Salm<span style="float: right;">33 (22)</span> </p>
                                                               <p style="line-height: 1.85"> Noman S<span style="float: right;"> 21 (14)</span> </p>
                                                                </div>
                                                        </div>
                                                        <div class="col-sm-5 col-xs-12 sp"> 
                                                          <div class="end-test">
                                                                <p style="line-height: 1.85">Ramkiran N<span style="float: right;">1.0-0-5-0</span> </p>
                                                              <p style="line-height: 1.85" class="hidden-phone">Run Rate : <span style="float: right"> 9.11</span>
                                                              </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-sm-2 sp">
                                              <div class="end-head sp">
                                                <table style="width: 100%"><tbody><tr><td>
                                                    <h4 class="hidden-phone">RTC</h4>
                                                    <h4 class="show-phone">Royal Tigers</h4>
                                                    <h4><span>82/1</span></h4>
                                                    </td><td style="text-align: right;"><label class="show-phone" style="font-size: 14px;color: white;">Run Rate : 9.11</label></td></tr></tbody></table>
                                                </div>
                                      ...
                                      <div class="summary-list">
                                      <ul class="list-inline bbb-row">
                                             <li class="commr"><p><i class="fa fa-comments-o"></i> <strong>10 runs needed in 3.0 overs (18 balls) with 9 wickets remaining. RRR: 3.33</strong></p></li>
                                      </ul>
                                     </div>
                                  <ul class="list-inline bbb-row" id="ballid_652019">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:50 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_652021">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                  Adeel A to Noman S, 2 runs </li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:51 PM<span> </span></span>
                       
                     <div class="col-1 text-right"> 
                     </div>
  </ul>
                                <ul class="list-inline bbb-row" id="ballid_652023">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:51 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_652024">
    ...
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:51 PM<span> </span></span>
                     ...
                     <div class="col-1 text-right"> 
                                ...
                                <ul class="list-inline bbb-row" id="ballid_652026">
          ...
          <li class="col2">     
                    ...
                    <li class="col3">
                  Adeel A to Noman S, 6 runs <strong> SIX</strong></li>
                     <span class="hidden-phone" style="float: right; font-size: 14px; margin-right: 10px;width: 135px;
    text-align: right;"><i class="fa fa-clock-o" style="padding-right: 3px;"></i>
                    9:52 PM<span> </span></span>
